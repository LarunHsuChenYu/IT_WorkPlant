<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PUR_InvoicePriceUpdate.aspx.cs" Inherits="IT_WorkPlant.Pages.PUR_InvoicePriceUpdate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 24px;">
        <img src="/Image/invoice.gif" alt="Price Up Icon" style="height: 60px;" />
        <span style="font-size: 32px; color: #0d6efd; font-weight: 800;">
            PUR Invoice Billing Price Update
        </span>
    </div>
